...
unsigned int nStakeTargetSpacing = 1 * 60 * 10; // DIFF: 10-minute block spacing
int64 nChainStartTime = 1480464000;
...
const string strMessageMagic = "S88Coin Signed Message:\n";
...
// s88coin: increasing Nfactor gradually
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "S88Coin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "http://www.coinsoda.org/coin=1008";
        CTransaction txNew;
        txNew.nTime = nChainStartTime;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(8888) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        ...
        assert(block.hashMerkleRoot == uint256("0xbebe9db4660312844c16b2089164b3ff6c700f1f7e57b7042e738c6229f10368"));
